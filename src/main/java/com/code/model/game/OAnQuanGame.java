...
public class OAnQuanGame {
    ...
    public OAnQuanGame() {
        this(new StandardRule(), new StandardMoveStrategy());
    }

    public OAnQuanGame(GameRule rule, MoveStrategy moveStrategy) {
        this.rule = rule;
    ...
    public boolean play(int squareId, boolean isClockwise) {
        ...
        moveStrategy.performMove(board, squareId, direction, currentPlayer, moveHistory);
