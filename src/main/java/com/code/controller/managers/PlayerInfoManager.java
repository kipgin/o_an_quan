...
public class PlayerInfoManager {
    ...
    public PlayerInfoManager(Label lblScoreP1, Label lblScoreP2, HBox boxPlayer1, HBox boxPlayer2) {
    ...
    public void updateActivePlayerHighlight(OAnQuanGame gameModel) {
        ...
        highlightPlayer(boxPlayer1, p1Turn);
        highlightPlayer(boxPlayer2, !p1Turn);
    }

    private void highlightPlayer(HBox box, boolean isActive) {
        if (isActive) {
